...
contract MollectorMarket is Pausable, Ownable {
    ...
    canBeStoredWith64Bits(_duration)
  {
    ...
    require(acceptPayTokens[_payToken], 'CyBallMarket: wrong pay token');
    ...
    whenNotPaused
  {
    ...
    if (_payToken == address(0)) {
      ...
      require(msg.value == 0, "CyBlocMarket: Invalid msg.value");
      amount = _bidAmount;
    }
    ...
    returns (uint256)
  {
    ...
    require(_isOnAuction(_auction));
    require(_payToken == _auction.payToken, 'CyBallMarket: wrong pay token');
